...
def Model():
    ...
    # KMeans 
    k_mean_model = KMeans(n_clusters=3,init=hirechical_centroids,max_iter=400,algorithm='elkan',random_state=42)
...
def All_Functions(InData,month):
    ...
    # Stroe Centroids Of Clusters in InData_Idx
    centroids = k_mean_model.cluster_centers_
    np.savetxt(f'Centroids_Kmean.csv',centroids,delimiter=',')
